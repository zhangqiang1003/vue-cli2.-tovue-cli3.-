 ...
 * 获取固件更新信息（get）
 */
export function sysFirmwareCheck(data) {
  let obj = {image_type: 'release'}
  Object.assign(obj, data)
  return Axios.get('/admin/sys_firmware_check', { params: obj }).then(data => {
    return Promise.resolve(data)
  }).catch(e => {
 ...
 * 温馨提示
 */
export function warmTipsApi() {
  return Axios.get('/admin/sys_warm_tips')
    .then(res => {
      if (Number.parseInt(res.ret) === 0) {
