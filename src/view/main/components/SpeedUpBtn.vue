        ...
        accStateGet(apiData)
          .then(data => {
            ...
            if (data.ret === 0) { // 非accing状态
              if (this.userConflict === 0 || this.accingUserConflict === 0) {
              ...
              } else if (this.userConflict !== 0 || this.accingUserConflict === 1) {
