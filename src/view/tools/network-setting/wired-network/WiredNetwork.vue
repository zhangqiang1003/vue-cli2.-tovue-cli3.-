<template>
  <div class="wired-network-body">
    ...
    <div class="pdt30">
      ...
      <dynamic-ip v-show="toggleIpType === 0" @busDyChecked="handleDyChecked"></dynamic-ip>
      <static-ip v-show="toggleIpType === 1" @busStChecked="handleStChecked"></static-ip>
      <primary-button
        height="56"
        :text="text"
        :disabled="waitingDy"
  ...
  methods: {
    ...
    saveStaticIpFn: function() {
      ...
      if (this.staticCheckPass[0] &&
        ...
        this.tip.msg = this.$t('i18n.STATIC_SETTING_TIP')
        this.tip.type = 'tip'
        this.tip.show = true
      }
    },
    ...
    apiNetWanSetDynamicFn: function(apiInfo) {
      ...
      let data = {}
      data.dns1 = apiInfo.DNS1
      data.dns2 = apiInfo.DNS2
      data.mtu = apiInfo.MTU
    ...
    handleDyChecked: function(data) {
      this.dynamicCheckbox = data
    },
    handleStChecked: function(data) {
